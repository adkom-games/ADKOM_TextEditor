...
- [ ] **Compile against the newest supported Editor with zero warnings.** The guidelines reject deprecated/obsolete API warnings and any warning originating from package content. Verified so far only on the development Editor (6000.3.19f1); the newest released line is 6000.5.
