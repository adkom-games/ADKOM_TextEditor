    ...
    public partial class TextEditorWindow
    {
        ...
        void BuildCommands()
        {
            ...
            _commands = new List<AteCommand>
            {
                ...
                new AteCommand { Id = "goto-bracket-prev", Scope = CmdScope.Editor,
                    VS = All(K(KeyCode.LeftBracket, ctrl: true, d: "Ctrl+[")),
                    VSCode = All(K(KeyCode.LeftBracket, ctrl: true, d: "Ctrl+[")),
                    Rider = All(K(KeyCode.LeftBracket, ctrl: true, d: "Ctrl+[")),
                    Run = _ => True(() => _code.GoToMatchingBracketPrev()) },
                ...
                new AteCommand { Id = "find-in-files", Scope = CmdScope.Global,
                    ...
                    VSCode = All(K(KeyCode.P, ctrl: true, d: "Ctrl+P")),
                    Rider = All(K(KeyCode.T, ctrl: true, d: "Ctrl+T")),
                    Run = _ => True(ShowQuickOpen) },
                new AteCommand { Id = "toggle-bookmark", Scope = CmdScope.Editor,
                    VS = All(K(KeyCode.K, ctrl: true, alt: true, d: "Ctrl+Alt+K")),
                    VSCode = All(K(KeyCode.K, ctrl: true, alt: true, d: "Ctrl+Alt+K")),
                    Rider = All(K(KeyCode.K, ctrl: true, alt: true, d: "Ctrl+Alt+K")),
                    Run = _ => True(ToggleBookmark) },
                new AteCommand { Id = "next-bookmark", Scope = CmdScope.Editor,
                    VS = All(K(KeyCode.N, ctrl: true, alt: true, d: "Ctrl+Alt+N")),
                    VSCode = All(K(KeyCode.N, ctrl: true, alt: true, d: "Ctrl+Alt+N")),
                    Rider = All(K(KeyCode.N, ctrl: true, alt: true, d: "Ctrl+Alt+N")),
                    Run = _ => True(() => JumpBookmark(1)) },
                new AteCommand { Id = "prev-bookmark", Scope = CmdScope.Editor,
                    VS = All(K(KeyCode.P, ctrl: true, alt: true, d: "Ctrl+Alt+P")),
                    VSCode = All(K(KeyCode.P, ctrl: true, alt: true, d: "Ctrl+Alt+P")),
                    Rider = All(K(KeyCode.P, ctrl: true, alt: true, d: "Ctrl+Alt+P")),
                    Run = _ => True(() => JumpBookmark(-1)) },
