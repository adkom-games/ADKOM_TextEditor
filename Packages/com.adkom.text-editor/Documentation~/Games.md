...
- **Getting the games**: the menu offers a one-click download of the MIT-licensed **Zork trilogy**. The files are fetched to your machine on your action — ATE ships no game file.
