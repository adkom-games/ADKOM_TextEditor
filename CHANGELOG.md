...
- **Locked rendered Markdown: the selection tint covers headings fully.** The overlay guessed line height as fontSize × 1.2 for single-line blocks, which undershoots the larger heading fonts (#/##/###) and clipped the highlight; single-line blocks now measure their real content height.
